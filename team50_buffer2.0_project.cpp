...
{
    int id;
    char name[20], Q[20], age[20], exp[20], city[20], special[20], phno[20], hospName[20];
};
struct patient1
{
    int id1;
    char name[20], age[20], city[20], dis[20], room[20], sym[20], con[20], date[20], charg[20], bill[20], hname[20];
};
...
public:
    ...
    void add_doc_info()
    {
        ...
        for (i = 1; i <= en; i++)
        {
            cout << "Enter Hospital's ID              : ";
            cin >> arr[docid].id;
            cout << "Enter the hospital name          : ";
            cin >> arr[docid].hospName;
            cout << "Enter phone number of hospital   : ";
            cin >> arr[docid].phno;
    ...
    void Display()
    {
        system("cls");
        int n, i;
        cout << "\n Enter the hospital's ID  to display Record :";
        cin >> n;
        if (n == 0)
        {
            cout << "\n\n                      OOPS!!!!             "
    ...
    void doctor_detail()
    {
        ...
        else
        {
            ...
            cout << "Hospital id"<< "\t\t"<< "Specialization"<< "\t\t"<< "Qualification"<< "\t\t" << "Age";
            cout << "\n\n";
...
void patient ::add_pat_info()
{
    ...
    for (i = 1; i <= en; i++)
    {
        ...
        cin >> arr[docid1].name;
        cout << " 3. Name of hospital where patient is admitted         : ";
        cin >> arr[docid1].hname;
        cout << " 4. Enter patient's Age                                : ";
        cin >> arr[docid1].age;
        ...
        cin >> arr[docid1].room;
        cout << " 8. Enter Patient's condition Before Admit             : ";
        cin >> arr[docid1].con;
...
xyz:
    ...
    xyz2:
        system("cls");
        cout << "\n\n";
        cout << "   1.   Enter  into Hospital and Doctor's    DataBase   " << endl;
