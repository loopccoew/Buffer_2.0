...
<body background="https://www.koolmaxgroup.com/blog/wp-content/uploads/2017/08/430afc50e8ad68594de9d1b020f99072.jpg" style="background-size:cover;margin: 0;">
	...
	<div class="content">
		<form action="editListOfCakes" method="post">
		<%
		...
		%>
			<table border="1">
				<tr>
						<th colspan="7" style="font-size: 30px;">Cake List</th>
				</tr>
				<tr>
					<td>Product ID
					<td>Cake Type
				...
				<tr>
					...
					<td><a href="deleteFromCakeList?productID=<%=((Cake)temp).getCakeID()%>">delete</a></td>
				</tr>
				<%}%>
